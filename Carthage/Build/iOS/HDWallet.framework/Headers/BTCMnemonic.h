...
- (id _Nullable) initWithEntropy:(NSData *)entropy password:(NSString * _Nullable)password wordListType:(BTCMnemonicWordListType)wordListType;
...
- (id _Nullable) initWithWords:(NSArray <NSString *>*)words password:(NSString * _Nullable)password wordListType:(BTCMnemonicWordListType)wordListType;
...
- (id _Nullable) initWithData:(NSData *)data;
