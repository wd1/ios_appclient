...
- (id) initWithSeed:(NSData *)seed network:(BTCNetwork * _Nullable)network;
...
- (BTCKeychain * _Nullable) derivedKeychainAtIndex:(uint32_t)index hardened:(BOOL)hardened factor:(BTCBigNumber * _Nullable * _Nullable)factorOut;
